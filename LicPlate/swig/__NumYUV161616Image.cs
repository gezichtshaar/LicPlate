...
public class __NumYUV161616Image : Image {
  ...
  internal __NumYUV161616Image(IntPtr cPtr, bool cMemoryOwn) : base(VisionLabPINVOKE.__NumYUV161616Image_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public YUV161616Pixel GetLastPixelPtr() {
    IntPtr cPtr = VisionLabPINVOKE.__NumYUV161616Image_GetLastPixelPtr(swigCPtr);
    YUV161616Pixel ret = (cPtr == IntPtr.Zero) ? null : new YUV161616Pixel(cPtr, false);
    if (VisionLabPINVOKE.SWIGPendingException.Pending) throw VisionLabPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public YUV161616Pixel GetPixelPtr(int x, int y) {
    IntPtr cPtr = VisionLabPINVOKE.__NumYUV161616Image_GetPixelPtr__SWIG_0(swigCPtr, x, y);
    YUV161616Pixel ret = (cPtr == IntPtr.Zero) ? null : new YUV161616Pixel(cPtr, false);
    if (VisionLabPINVOKE.SWIGPendingException.Pending) throw VisionLabPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
