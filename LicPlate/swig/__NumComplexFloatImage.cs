...
public class __NumComplexFloatImage : Image {
  ...
  internal __NumComplexFloatImage(IntPtr cPtr, bool cMemoryOwn) : base(VisionLabPINVOKE.__NumComplexFloatImage_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public SWIGTYPE_p_std__complexT_float_t GetFirstPixelPtr() {
    IntPtr cPtr = VisionLabPINVOKE.__NumComplexFloatImage_GetFirstPixelPtr(swigCPtr);
  ...
  public SWIGTYPE_p_std__complexT_float_t GetLastPixelPtr() {
    IntPtr cPtr = VisionLabPINVOKE.__NumComplexFloatImage_GetLastPixelPtr(swigCPtr);
    SWIGTYPE_p_std__complexT_float_t ret = (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_std__complexT_float_t(cPtr, false);
    if (VisionLabPINVOKE.SWIGPendingException.Pending) throw VisionLabPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public SWIGTYPE_p_std__complexT_float_t GetPixelPtr(int x, int y) {
    IntPtr cPtr = VisionLabPINVOKE.__NumComplexFloatImage_GetPixelPtr__SWIG_0(swigCPtr, x, y);
    SWIGTYPE_p_std__complexT_float_t ret = (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_std__complexT_float_t(cPtr, false);
    if (VisionLabPINVOKE.SWIGPendingException.Pending) throw VisionLabPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public SWIGTYPE_p_std__complexT_float_t GetPixelPtr(XYCoord xy) {
    IntPtr cPtr = VisionLabPINVOKE.__NumComplexFloatImage_GetPixelPtr__SWIG_1(swigCPtr, XYCoord.getCPtr(xy));
    SWIGTYPE_p_std__complexT_float_t ret = (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_std__complexT_float_t(cPtr, false);
    if (VisionLabPINVOKE.SWIGPendingException.Pending) throw VisionLabPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
