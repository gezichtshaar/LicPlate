...
public class __NumComplexDoubleImage : Image {
  ...
  internal __NumComplexDoubleImage(IntPtr cPtr, bool cMemoryOwn) : base(VisionLabPINVOKE.__NumComplexDoubleImage_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public SWIGTYPE_p_std__complexT_double_t GetFirstPixelPtr() {
    IntPtr cPtr = VisionLabPINVOKE.__NumComplexDoubleImage_GetFirstPixelPtr(swigCPtr);
  ...
  public SWIGTYPE_p_std__complexT_double_t GetLastPixelPtr() {
    IntPtr cPtr = VisionLabPINVOKE.__NumComplexDoubleImage_GetLastPixelPtr(swigCPtr);
    SWIGTYPE_p_std__complexT_double_t ret = (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_std__complexT_double_t(cPtr, false);
    if (VisionLabPINVOKE.SWIGPendingException.Pending) throw VisionLabPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public SWIGTYPE_p_std__complexT_double_t GetPixelPtr(int x, int y) {
    IntPtr cPtr = VisionLabPINVOKE.__NumComplexDoubleImage_GetPixelPtr__SWIG_0(swigCPtr, x, y);
    SWIGTYPE_p_std__complexT_double_t ret = (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_std__complexT_double_t(cPtr, false);
    if (VisionLabPINVOKE.SWIGPendingException.Pending) throw VisionLabPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
