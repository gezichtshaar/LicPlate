...
public class __NumRGB161616Image : Image {
  ...
  internal __NumRGB161616Image(IntPtr cPtr, bool cMemoryOwn) : base(VisionLabPINVOKE.__NumRGB161616Image_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public RGB161616Pixel GetFirstPixelPtr() {
    IntPtr cPtr = VisionLabPINVOKE.__NumRGB161616Image_GetFirstPixelPtr(swigCPtr);
  ...
  public RGB161616Pixel GetLastPixelPtr() {
    IntPtr cPtr = VisionLabPINVOKE.__NumRGB161616Image_GetLastPixelPtr(swigCPtr);
    RGB161616Pixel ret = (cPtr == IntPtr.Zero) ? null : new RGB161616Pixel(cPtr, false);
    if (VisionLabPINVOKE.SWIGPendingException.Pending) throw VisionLabPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public RGB161616Pixel GetPixelPtr(int x, int y) {
    IntPtr cPtr = VisionLabPINVOKE.__NumRGB161616Image_GetPixelPtr__SWIG_0(swigCPtr, x, y);
    RGB161616Pixel ret = (cPtr == IntPtr.Zero) ? null : new RGB161616Pixel(cPtr, false);
    if (VisionLabPINVOKE.SWIGPendingException.Pending) throw VisionLabPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public RGB161616Pixel GetPixelPtr(XYCoord xy) {
    IntPtr cPtr = VisionLabPINVOKE.__NumRGB161616Image_GetPixelPtr__SWIG_1(swigCPtr, XYCoord.getCPtr(xy));
    RGB161616Pixel ret = (cPtr == IntPtr.Zero) ? null : new RGB161616Pixel(cPtr, false);
    if (VisionLabPINVOKE.SWIGPendingException.Pending) throw VisionLabPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
